    		...
    		items: [
        		...
        		handler: function() {
        			settings = {
        				...
        				value: '&nbsp;&nbsp;This is a free and open source (<a href="http://www.gnu.org/licenses/gpl-3.0.html" target="_blank">GPL3 license</a>) '
               					+ 'application that demonstrate some functions of <a href="http://code.google.com/p/java-simple-serial-connector/" target="_blank">jSSC (Java Simple Serial Connector)</a> library and JavaScript jSSC-Bridge.<br><br>' 
               					+ '&nbsp;&nbsp;You can use this terminal for your work and make changes in '
               					+ 'source code (under terms of <a href="http://www.gnu.org/licenses/gpl-3.0.html" target="_blank">GPL3 license</a>).<br><br>'
               					+ '<center><b>Based on jSSC-' + jSSC.getLibraryVersion() + '</b><br><br></center>'
               					+ '<center>Author: Sokolov Alexey aka scream3r</center>',
               			closeButton: true
        			}
